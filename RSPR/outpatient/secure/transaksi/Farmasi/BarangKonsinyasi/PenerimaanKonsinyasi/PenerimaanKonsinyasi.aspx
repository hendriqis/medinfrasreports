<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PenerimaanKonsinyasi.aspx.vb"
    Inherits="QIS.Web.secure.transaksi.Farmasi.BarangKonsinyasi.PenerimaanKonsinyasi.PenerimaanKonsinyasi" %>
...
<html>
<head>
    <title>Penerimaan Barang Konsinyasi</title>
    <meta content="Microsoft Visual Studio.NET 7.0" name="GENERATOR">
    <meta content="Visual Basic 7.0" name="CODE_LANGUAGE">
    <meta content="JavaScript" name="vs_defaultClientScript">
    <meta content="http://schemas.microsoft.com/intellisense/ie5" name="vs_targetSchema">
    <link href="/qislib/css/syles.css" type="text/css" rel="Stylesheet">
...
<body onload="ShowPosting();fokus();"">
    <form id="frmpenerimaankonsinyasi" method="post" runat="server">
                    ...
                    <table cellspacing="10" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td align="left">
                                                        ...
                                                        <td class="rbodycol">
                                                                ...
                                                                <tr>
                                                                    <td valign="top" width="50%">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td width="30%">
                                                                                    <asp:LinkButton ID="lBtnNoPenerimaan" Text="No. Penerimaan" runat="server" CausesValidation="False" />
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtTglTerima" runat="server" ReadOnly="true" Width="95%" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">
                                                                    ...
                                                                    <td valign="top" width="50%">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtNoKirim" runat="server" Width="95%" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td width="30%">
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtGudang" runat="server" AutoPostBack="True" MaxLength="25" Width="24%" />
                                                                                    <asp:TextBox ID="txtNamaGudang" runat="server" ReadOnly="true" Width="70%" />
                                                            ...
                                                            <asp:Panel ID="panelPenerimaanAddNewRow" runat="server">
                                                                <table class="rBodyAddNew" cellspacing="0" bordercolordark="#98aab1" cellpadding="5"
                                                                    ...
                                                                    <tr class="rheader">
                                                                        <td class="rheadercol" align="left" height="25">
                                                                            Edit atau Tambah Item Penerimaan Barang Konsinyasi
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <table cellspacing="1" cellpadding="1" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="rBodyAddNewFld">
                                                                                        <asp:CompareValidator ID="cvDiskonRp" runat="server" ControlToValidate="Penerimaan_AddNewRow_txtDiskonRp"
                                                                                            Operator="DataTypeCheck" Type="Currency" ErrorMessage="Diskon Rp" Display="Dynamic">
																					** Harus diisi dengan angka **
                                                                                        </asp:CompareValidator>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="rBodyAddNewFld" width="40%">
                                                                                        <asp:TextBox ID="Penerimaan_AddNewRow_txtJumlah" runat="server" Width="100%" ReadOnly="True" />
                                                                                    </td>
                                                                                    <td class="rBodyAddNewFld">
                                                                                        &nbsp;
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="rBodyAddNewFld" width="40%">
                                                                                        <asp:TextBox ID="Penerimaan_AddNewRow_txtExpired" runat="server" Width="100%" />
                                                                                    </td>
                                                                                    <td class="rBodyAddNewFld">
                                                                                        &nbsp;
                                                                                    </td>
                                                                        ...
                                                                        <asp:DataGrid ID="gridPenerimaan" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateColumn runat="server" HeaderText="Faktor" ItemStyle-HorizontalAlign="Right"
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:Label runat="server" Style="margin-left: 10; margin-right: 10" Text='<%# Format(DataBinder.Eval(Container.DataItem, "faktor"),"#,##0.00") %>'
                                                                                            ID="_lblFaktor" />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateColumn>
                                                            ...
                                                            <div id="RelatedLinkDiv" style="overflow: auto; width: 100%;">
                                                                <table width="100%" bgcolor="MintCream" cellspacing="10" cellpadding="0">
                                                                    <tr valign="top" style="display: none">
                                                                        <td width="50%" id="rbiu">
                                                                            <p>
                                                                                <strong>Update Penerimaan</strong>
                                                                                <br />
                                ...
                                <asp:Panel ID="panelSalinPesanan" runat="server" Visible="false">
                                    <!--#include file="SalinPesananK_Grid.incl.aspx" -->
                                </asp:Panel>
                            </td>
                        </tr>
                    </table>
    ...
    <div id="divRightPanelTasksContent">
        <div class="rightPanelContent borderBox">
            <asp:Button ID="btnSalinPesanan" onmouseover="rbis.style.backgroundColor='#ffd27a'"
                onmouseout="rbis.style.backgroundColor='MintCream'" runat="server" causevalidation="True"
                Text="Go" CssClass="sbttn" />
            <div class='qmtitle'>Salin Pesanan Barang Konsinyasi</div>
            <div class='qmdescription'>Salin Pesanan Barang Konsinyasi per Pemasok.</div>
        </div>
    </div>
    <%--<div id="divRightPanelPrintContent">
        <div class="rightPanelContent borderBox">
            <asp:Button ID="btnCetakPenerimaanKonsiyasi" runat="server" Text="Go" CausesValidation="False"
            ...
            <div class='qmtitle'>Cetak Bukti Penerimaan Barang Konsinyasi</div>
            <div class='qmdescription'>Cetak Bukti Penerimaan Barang Konsinyasi.</div>
        </div>
    </div>--%>
    <div id="divRightPanelPrintContent">
        ...
        <asp:RadioButtonList ID="rdbCetakan" CssClass="rdbCetakan" runat="server">
            <asp:ListItem Value="ctkPenerimaanKonsiyasi" Text="Cetak Bukti Penerimaan Barang Konsinyasi" Selected="True"></asp:ListItem>
        </asp:RadioButtonList>
        <br />
...
<script language="javascript">
    function fokus() {
        try {
            var kdbarang;
            kdbarang = document.getElementById('Penerimaan_AddNewRow_txtKodeItem').value;
            ...
            if (kdbarang == '') {
                ...
                document.getElementById('Penerimaan_AddNewRow_txtKuantitas').focus();
                document.getElementById('Penerimaan_AddNewRow_txtKuantitas').select();
            }
        }
        catch (e) {
        }
