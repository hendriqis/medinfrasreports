...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ApprovalPR.aspx.vb" Inherits="QIS.Web.secure.transaksi.Farmasi.Pembelian.PurchaseRequest.ApprovalPR" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Approval Permintaan Pembelian</title>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="10%" align="right">
                                                            <br />
                                                            <asp:Button ID="btnApprovalPR" runat="server" Text="Proses" Width="100" CssClass="sbttn"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                            ...
                                                            <asp:DataGrid ID="gridPermintaanPembelian" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn SortExpression="qtyminta" runat="server" HeaderText="Qty. Minta"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtQtyMinta" AutoPostBack="False" runat="server" Style="margin-left: 5;
                                                                                margin-right: 5; text-align:right"  BackColor="Transparent" Text='<%# format(DataBinder.Eval(Container.DataItem, "qtyminta"), "#,##0.00") %>'
                                                                                Width="75" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn SortExpression="QtySaldoAkhir" runat="server" HeaderText="Saldo Stock"
                                                                        ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" Visible="True">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" Style="margin-left: 5; margin-right: 5" Text='<%# DataBinder.Eval(Container.DataItem, "QtySaldoAkhir") %>'
                                                                                ID="_lblSaldoStock" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="Diskon %" ItemStyle-HorizontalAlign="Right"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" Style="margin-left: 5; margin-right: 5" Width="40" Text='<%# format(DataBinder.Eval(Container.DataItem, "diskonpc"), "##0.00") %>'
                                                                                ID="_lblDiskonPc" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn SortExpression="approval" runat="server" HeaderText="Approval"
                                                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" Visible="True">
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox runat="server" Enabled="true" Checked='<%# DataBinder.Eval(Container.DataItem, "approval") %>'
                                                                                ID="_chkApp" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
