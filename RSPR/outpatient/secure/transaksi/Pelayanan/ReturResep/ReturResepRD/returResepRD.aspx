<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="returResepRD.aspx.vb"
    Inherits="QIS.Web.secure.transaksi.Pelayanan.ReturResep.ReturResepRD.returResepRD" %>
...
<html>
<head>
    <title>Retur Penjualan Resep Pasien IGD</title>
    ...
    <script language="javascript">
        ...
        function richDialog() {
            ...
            // x,y,w,h
            oPopup.show(topper, lefter + 20, 550, 230, ttip);
        }
                        ...
                        <tr>
                            <td align="left">
                                    ...
                                    <table cellspacing="0" cellpadding="5" width="100%">
                                        <tr class="rheader">
                                            <td class="rheadercol" align="left" height="25">
                                                Retur Penjualan Resep Pasien IGD
                                            </td>
                                        </tr>
                                        <tr class="rbody">
                                                            ...
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtTglResep" runat="server" MaxLength="10" Width="80%" Visible="False" />
                                                                ...
                                                                <tr style="display: none;">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtNoReg" AutoPostBack="true" runat="server" MaxLength="15" Width="95%"
                                                                            ReadOnly="True" />
                                                                        <asp:TextBox ID="txtTglReg" runat="server" MaxLength="10" Width="80%" ReadOnly="True"
                                                                            Style="display: none" />
                                                                    </td>
                                                                </tr>
                                                                <tr style="display: none;">
                                                                                ...
                                                                                <p>
                                                                                    <table width="100%" bgcolor="MintCream" bgcolor="#b0c7cb" id="__infp">
                                                                                        ...
                                                                                        <tr style="display: none">
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="lbtnSeks" runat="server" />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="30%">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="lbtnTglLahir" runat="server" Text="01-07-1976</b> " />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="30%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtKodeGudang" AutoPostBack="true" runat="server" MaxLength="5"
                                                                            Width="24%" />
                                                                        <asp:TextBox ID="lblNamaGudang" runat="server" Text="Gudang Pusat" Width="70%" ReadOnly="true" />
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" cellpadding="1" cellspacing="1">
                                                                                ...
                                                                                <tr style="display: none">
                                                                                    ...
                                                                                    <td class="rBodyAddNewFld">
                                                                                        &nbsp;/&nbsp;Harga :&nbsp; <b>
                                                                                            <asp:Label ID="AddNewRow_lblUangR" runat="server" /></b>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="display: none">
                                                                                    <td width="20%" class="rBodyAddNewFld">
                                        ...
                                        <tr class="rbody">
                                            <td align="right">
                                                <table>
                                                    <tr class="rbody">
                                                        <td align="right">
                                                            <asp:Label ID="lblJudulTotal" runat="server" Text="Total Nilai Retur Obat">
                                                            </asp:Label>&nbsp;:
                                                        </td>
                                                        <td align="right">
                                                            &nbsp;Rp.&nbsp;
                                ...
                                <asp:Panel ID="PanelSalinRetur" runat="server">
                                    <!--#include file="SalinReturResep_Grid.incl.aspx" -->
