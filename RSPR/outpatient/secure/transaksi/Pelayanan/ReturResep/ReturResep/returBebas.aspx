<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="returBebas.aspx.vb" Inherits="QIS.Web.secure.transaksi.Pelayanan.ReturResep.ReturResep.returBebas" %>
...
<html>
<head>
    <title>Retur Penjualan Resep Pasien Luar dan Obat Bebas</title>
...
<body ms_positioning="GridLayout" onload="ShowPosting()">
                                ...
                                <table cellspacing="0" cellpadding="5" width="100%">
                                    <tr class="rheader">
                                        <td class="rheadercol" align="left" height="25">
                                            Retur Penjualan Resep Pasien Luar dan Obat Bebas
                                        </td>
                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="50%" valign="top">
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td width="40%">
                                                                        <asp:TextBox ID="txtNoBukti" AutoPostBack="true" runat="server" MaxLength="20" Width="80%" CssClass="txtautogenerate"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="40%">
                                                                    ...
                                                                    <td width="40%">
                                                                        <asp:TextBox ID="txtNoResep" AutoPostBack="true" runat="server" MaxLength="15" Width="80%" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:RequiredFieldValidator ID="rfvNoResep" runat="server" ControlToValidate="txtNoResep"
                                                                            ErrorMessage="NoResep" Display="dynamic">
																												** 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="40%">
                                                                        <asp:TextBox ID="txtTanggal" ReadOnly="true" runat="server" Width="80%" />
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlAlsRetur" runat="server" Width="80%" />
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td></td>
                                                                    <td>
                                                                        <asp:CheckBox ID="chkObatBebas" runat="server" Text="Obat Bebas" Enabled="False" />
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <td width="50%" valign="top">
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtKodeGudang" AutoPostBack="true" runat="server" MaxLength="5"
                                                                            Width="24%" />
                                                                        <asp:TextBox ID="lblNamaGudang" runat="server" Text="" Width="70%" ReadOnly="true" />
                                                                ...
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblDokter" CausesValidation="False" Text="Dokter" runat="server" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtKodeDokter" AutoPostBack="true" runat="server" MaxLength="10"
                                                                            Width="24%" ReadOnly="True" />
                                                                        <asp:TextBox ID="lblNamaDokter" runat="server" Text="" Width="70%" ReadOnly="true" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblDokterLuar" CausesValidation="False" Text="Dokter Luar" runat="server" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtDokterLuar" runat="server" MaxLength="10" Width="95%" ReadOnly="True" />
                                                                    </td>
                                                                </tr>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" cellpadding="1" cellspacing="1">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="25%" class="rBodyAddNewFld">
                                                                                        <asp:Label ID="AddNewRow_lblNamaBarang" runat="server" ReadOnly="True" Width="100%" />
                                                                                    </td>
                                                                                    <td class="rBodyAddNewFld">
                                                                                        &nbsp;
                                                                                    </td>
                                                        ...
                                                        <td width="100%" height="100%">
                                                            <asp:DataGrid ID="gridReturResep" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="Uang R" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right" Visible="True">
                                                                        <ItemTemplate>
                                        ...
                                        <tr class="rbody">
                                            <td align="right">
                                                <table>
                                                    <tr>
                                                        <td align="right">
                                                            <asp:Label ID="lblJudulTotal" runat="server" Text="Total Nilai Retur">
                                                            </asp:Label>&nbsp;:
                                                        </td>
                                                        <td align="right">
                                                            &nbsp;Rp.&nbsp;
                                    ...
                                    <asp:Panel ID="PanelSalinRetur" runat="server">
                                        <!--#include file="SalinReturResepBebas_Grid.incl.aspx" -->
    ...
    <div id="divRightPanelPrintContent">
        ...
        <asp:RadioButtonList ID="rdbCetakan" CssClass="rdbCetakan" runat="server">
            <asp:ListItem Value="ctkCetakRetur" Text="Cetak Nota Retur Penjualan Resep" Selected="True"></asp:ListItem>
        </asp:RadioButtonList>
        <br />
