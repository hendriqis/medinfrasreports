    ...
    <tr>
        ...
        <td width="50%" valign="top">
            <table width="100%">
                ...
                <tr>
                    <td width="30%">
                        <asp:label id="lblNoBuktiRj" text="No. Bukti Rawat Jalan" runat="server" />
                    </td>
                    <td>
                        <asp:textbox id="txtNoBuktiRj" runat="server" width="95%" readonly="true" />
            ...
            <!--#Include File="InformasiPasienRJ.incl.aspx"-->
        </td>
        <!-- ---------------------------------
			END LEFT SECTION
		------------------------------------- -->
