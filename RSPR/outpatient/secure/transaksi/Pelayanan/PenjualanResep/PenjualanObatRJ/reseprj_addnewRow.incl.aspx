							...
							<td width="50%" valign="top">
									...
									<tr>
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtJumlahObat" 
															...
															Text="0.00" 
															AutoPostBack="False" 
															onblur="hitunghasiljs();"
															style="text-align:right;" />
											<asp:textbox id="AddNewRow_Satuan" runat="server" width="150" ReadOnly="True" />														
										</td>
										<td class=rBodyAddNewFld>
											<asp:textbox id="AddNewRow_Satuan_code" runat="server" width="150" ReadOnly="True" visible="false"/>										
										</td>
									</tr>
								...
								<asp:Panel id="pnlJmlKemasO" runat="server">
										...
										<tr>
											...
											<td width="40%" class=rBodyAddNewFld>
												<asp:textbox id="AddNewRow_txtJumlahO" runat="server" width="100%" Text="0.00" AutoPostBack="True" style="text-align:right;" />
											</td>
											<td class=rBodyAddNewFld>&nbsp;
											</td>
										</tr>
							...
							<td width="50%" valign="top">
								...
								<TABLE width="100%" cellpadding=1 cellspacing=2 >
							        <tr>
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:Textbox id="AddNewRow_Hasil" 
															runat="server" 
															width="354" 
															text="0.00" 
															ReadOnly="True"
										...
										<td class=rBodyAddNewFld>
											<asp:label	id="AddNewRow_QtyStock" 
														runat="server" 
														width="100%" 
														text="0.00" 
														Visible="False" />
														
											<asp:Label	class="error" 
														id="lblError" 
														runat="server" 
														width="100%" />
										</td>
									...
									<tr style="display:none">
										...
										<td class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtHpr" 
															runat="server" 
															Readonly=True 
															Visible="False" />																				
															
											<asp:textbox	id="AddNewRow_txtHargaDsr" 
															runat="server" 
															Readonly=True 
															Visible="False" />
															
											<asp:textbox	id="AddNewRow_txtMarkUp" 
															runat="server" 
															Readonly=True 
															Visible="False" />											
															
											<asp:textbox	id="AddNewRow_txtCoverage" 
															runat="server" 
															Readonly=True 
															Visible="False" />											
										</td>
									...
									<tr>
										...
										<td width="60%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtHarga" 
															runat="server" 
															Readonly="False" 
															width="175" 
															Text="0.00" 
											...
											<asp:textbox	id="AddNewRow_txtSelisih" 
															runat="server" 
															Readonly="False" 
															width="175" 
															Text="0.00" 
										...
										<td class=rBodyAddNewFld>											
											<asp:CheckBox	id="AddNewRow_chkCito" 
															...
															Text="Cito" 
															Visible="False" />
											<asp:CompareValidator	id="cvHarga" 
																	runat="server" 
																	ControlToValidate="AddNewRow_txtHarga" 
									...
									<tr>
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtDiskon" 
															runat="server" 
															width="354" 
															Text="0.00"
															ReadOnly="false" 
										...
										<td class=rBodyAddNewFld>											
											<asp:CompareValidator	id="cvDiskon" 
																	runat="server" 
																	ControlToValidate="AddNewRow_txtDiskon" 
																	Operator="DataTypeCheck" 
																	Type="Double" 
																	ErrorMessage="Diskon" 
																	Display="Dynamic">
											...
											<asp:RangeValidator id="rvDiskon" 
																runat="server" 
																ControlToValidate="AddNewRow_txtDiskon" 
																MaximumValue="100.00" 
																MinimumValue="0.00" 
									...
									<tr>
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtDiskonAmount" 
															runat="server" 
															width="354" 
															Text="0.00" 
															ReadOnly="false"
										...
										<td class=rBodyAddNewFld>											
											<asp:CompareValidator	id="cvDiskonAmount" 
																	runat="server" 
																	ControlToValidate="AddNewRow_txtDiskonAmount" 
																	Operator="DataTypeCheck" 
																	Type="Double" 
								...
								<asp:Panel id="pnlUangR" runat="server">
									...
									<tr style="display:none">
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_txtTotal" 
															runat="server" 
															Readonly="False" 
															width="354" 
															Text="0.00"
									...
									<tr style="display:none">
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox	id="AddNewRow_TglExpired" 
															runat="server" 
															width="354"/>
										</td>
										<td class=rBodyAddNewFld>&nbsp;
									...
									<tr>
										...
										<TD width="55%" class=rBodyAddNewFld>
											<asp:TextBox	id="AddNewRow_txtAturanPakai" 
															runat="server" width="150" AutoPostBack="True"/>
														
											<ASP:TextBox 
												ID="AddNewRow_lblAturanPakai" 
												RUNAT="server" width="200" readonly="true">
											</ASP:TextBox>
										</TD>
										<TD class=rBodyAddNewFld>&nbsp;
										</TD>																
						...
						<TR>
							<TD width="100%" align="left" colspan="2">
								...
								<asp:Button id="btnDone" 
											...
											CausesValidation="False" 
											CssClass=sbttn
											AccessKey="D" width="100"></asp:Button>								
							</TD>
						</TR>
