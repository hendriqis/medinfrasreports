...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reseprj.aspx.vb" Inherits="QIS.Web.secure.transaksi.Pelayanan.PenjualanResep.PenjualanObatRJ.reseprj" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Penjualan Resep Pasien Rawat Jalan</title>
...
<body ms_positioning="GridLayout" onload="ShowPosting();fokus();">
    ...
    <table border="0" style="height: 100%;" width="100%" cellspacing="2" cellpadding="1">
        <tr>
                                        ...
                                        <td class="rheadercol" align="left" height="25" colspan="2">
                                            <a href="javascript:Done();">
                                                <img border="0" src="/qislib/images/back.png" alt="Kembali ke halaman Pilih Pasien"
                                                    align="absmiddle" />
                                            </a>&nbsp; Penjualan Resep Pasien Rawat Jalan
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td class="rbodycol" align="middle" height="25" colspan="2">
                                            <!--#include file="reseprj_hd.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td class="rbodycol" align="middle" height="25" colspan="2">
                                            <!--#include file="reseprj_addnewRow.incl.aspx" -->
                                            <!--#include file="reseprj_Grid.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td align="right">
                                                                ...
                                                                <tr valign="top" style="display: none">
                                                                    ...
                                                                    <td align="left">
                                                                        <input type="button" name="btnrl_notapasien" id="btnrl_notapasien" class="sbttn"
                                                                            ...
                                                                            value="Go..." onclick="javascript:window.open('http://' + location.host + '<%# QIS.Common.Hisconfiguration.ReportsFolder %>fm_/bukti/notareseppbd.asp?is=' + document.getElementById('txtNoResep').value + '',null,'status=no,resizable=yes,toolbar=no,menubar=no,location=no');" />
                                                                    </td>
                                                                </tr>
                                                                <tr valign="top" style="display: none">
                                                                    ...
                                                                    <td align="left">
                                                                        <input type="button" name="btnrl_notainstansi" id="btnrl_notainstansi" class="sbttn"
                                                                            ...
                                                                            value="Go..." onclick="javascript:window.open('http://' + location.host + '<%# QIS.Common.Hisconfiguration.ReportsFolder %>fm_/bukti/notaresepins.asp?is=' + document.getElementById('txtNoResep').value + '',null,'status=no,resizable=yes,toolbar=no,menubar=no,location=no');" />
                                                                    </td>
                                                                </tr>
                                                                <tr valign="top" style="display: none">
                                                                    <td width="80%" id="rbir">
    ...
    <script language="javascript">
        ...
        function fokusSave() {
            try {
                var qtyR;
                var qty;
                qtyR = document.getElementById('AddNewRow_txtJumlahR').value;
                qty = document.getElementById('AddNewRow_Hasil').value;
                qtyR = ditrim(qtyR);
                qty = ditrim(qty);
                if (qtyR == '0.00' && qty != '0.00') {
                    document.getElementById('btnAddNewRow').focus();
                }
            }
            catch (e) {
            }
