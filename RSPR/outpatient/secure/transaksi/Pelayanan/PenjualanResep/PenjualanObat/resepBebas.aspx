<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="resepBebas.aspx.vb" Inherits="QIS.Web.secure.transaksi.Pelayanan.PenjualanResep.PenjualanObat.resepBebas" %>
...
<html>
<head>
    <title>Penjualan Resep Pasien Luar dan Obat Bebas</title>
...
<body ms_positioning="GridLayout" onload="ShowPosting();fokus();">
    <form id="frmResepBebas" runat="server">
    ...
    <table border="0" height="100%" width="100%" cellspacing="2" cellpadding="1">
        <tr>
                                ...
                                <table cellspacing="0" cellpadding="5" width="100%">
                                    <tr class="rheader">
                                        <td class="rheadercol" align="left" height="25">
                                            Penjualan Resep Pasien Luar dan Obat Bebas
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td class="rbodycol" align="center" height="25">
                                            <!--#include file="resepBebas_hd.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td class="rbodycol" align="center" height="25">
                                            <!--#include file="resepBebas_addnewRow.incl.aspx" -->
                                            <!--#include file="resepBebas_Grid.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td align="right">
                                            <table>
                                                <tr class="rbody">
                                                    <td align="right">
                                                        <asp:Label ID="lblJudulSelisih" runat="server" Text="Total Selisih"></asp:Label>&nbsp;:
                                                    </td>
                                                    <td align="right">
                                                        &nbsp;Rp.&nbsp;
                                                    </td>
                                                    <td align="right">
                                                        <asp:TextBox ID="lblTotalSelisih" runat="server" ReadOnly="True" class="right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="rbody">
                                                    <td align="right">
                                                        <asp:Label ID="lblJudulTotal" runat="server" Text="Total Nilai Penjualan Resep"></asp:Label>&nbsp;:
                                                    </td>
                                                    <td align="right">
                                                        &nbsp;Rp.&nbsp;
                                                    </td>
                                                    <td align="right">
                                                        <asp:TextBox ID="lblTotal" runat="server" ReadOnly="True" class="right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="rbody" style="display: none">
                                                    <td align="right">
                                                        Diskon % :
                                                        <asp:TextBox ID="txtHdDiskonPc" runat="server" AutoPostBack="True" class="right"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                                        Diskon Rp :
                                                    </td>
                                                    <td align="right">
                                                        &nbsp;Rp.&nbsp;
                                                ...
                                                <tr class="rbody" style="display: none">
                                                    ...
                                                    <td align="right">
                                                        <asp:TextBox ID="lblPPn" runat="server" ReadOnly="True" class="right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="rbody" style="display: none">
                                                    <td align="right">
                                                    ...
                                                    <td align="right">
                                                        <asp:TextBox ID="lblTotalAftPPn" runat="server" ReadOnly="True" class="right"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <div id="RelatedLinkDiv" style="overflow: auto; width: 100%;">
                                                <table width="100%" bgcolor="mintcream" cellspacing="10" cellpadding="0">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td id="InforamsiAnggotaInstansi" width="45%">
                                                            <p>
                                                                <font class="txtstrong">Informasi Keanggotaan Instansi</font>
                                                                <br />
                                                                Melihat Informasi Instansi dan Daftar Anggota yang Terdaftar Pada Instansi Terkait
                                                            </p>
                                                        </td>
                                                        <td align="left">
                                                            <input class="sbttn" id="btnRLInfoAnggotaInstansi" onmouseover="InforamsiAnggotaInstansi.style.backgroundColor='#ffd27a'"
                                                                onclick="javascript:window.open('./InfoKeanggotaanInstansi/default.aspx','null','location=1,status=1,scrollbars=1,width=800,height=600')"
                                                                onmouseout="InforamsiAnggotaInstansi.style.backgroundColor='MintCream'" type="button"
                                                                value="Go...">
                                                        </td>
                                                    </tr>
                                                    <tr valign="top">
                                                        <td id="rc_a" width="20%">
                                                            <p>
                                                                <font class="txtstrong">Print Cetak Nota Resep ( Direct ) dan Etiquette</font>
                                                                <br />
                                                                Print Cetak Nota Resep ( Direct ) dan Etiquette.
                                                            </p>
                                                        </td>
                                                        <td align="left">
                                                            
                                                        </td>
                                                        <td width="45%" id="rbbyr">
                                                            <p>
                                                                <font class="txtstrong">Pembayaran Penjualan Resep</font>
                                                                <br />
                                                                Pembayaran Penjualan Resep.
                                                            </p>
                                                        </td>
                                                        <td align="left">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td align="left">
                                                            <input type="button" name="btnCetak2" id="btnCetak2" class="sbttn" onmouseover="rbis.style.backgroundColor='#ffd27a'" style="display:none"
                                                                onmouseout="rbis.style.backgroundColor='MintCream'" value="Go..." onclick="javascript:window.open('http://' + location.host + '<%# QIS.Common.Hisconfiguration.ReportsFolder %>/fm_/Bukti/SalinanResepBbs.asp?is=' + document.getElementById('txtNoResep').value + '',null,'status=no,resizable=yes,toolbar=no,menubar=no,location=no');">
                                                        ...
                                                        <td width="45%" id="rbba">
                                                            <p>
                                                                ...
                                                                <br />
                                                                Batal Approval transaksi; data bisa dibatalkan bila belum ada pembayaran.
                                                            </p>
                                                        </td>
                                                        <td align="left">
                                                            <asp:Button ID="btnUnposting" onmouseover="rbba.style.backgroundColor='#ffd27a'"
                                                                onmouseout="rbba.style.backgroundColor='MintCream'" runat="server" Text="Go..."
    ...
    <%--<div id="divRightPanelPrintContent">
        <div class="rightPanelContent borderBox">
            <asp:Button ID="btnCetakNotaEtiquette" runat="server" class="sbttn" CausesValidation="False"
        ...
        <div class="rightPanelContent borderBox">
            <asp:Button ID="btnCetakSalinanResep" runat="server" class="sbttn" CausesValidation="False"
                onmouseover="rbis.style.backgroundColor='#ffd27a'" onmouseout="rbis.style.backgroundColor='MintCream'"
                Text="Go" />
        ...
        <div class="rightPanelContent borderBox" style="display: none;">
            <asp:Button ID="PrintCetakNotaResepdanEtiquette" onmouseover="rc_a.style.backgroundColor='#ffd27a'"
    ...
    <script language="javascript">
                ...
                if (satuan == true) {
                    if (potong == 2) {
                        ...
                        if ((parseInt(jumlah * jumlahR)) == (jumlah * jumlahR)) {
                            ...
                            //alert(parseInt(jumlah * jumlahR));
                            //alert(jumlah);
                            //alert(jumlahR);
                            //alert(jumlah * jumlahR);
                            //alert(hasil);
                        }
                    }
                }
        ...
        function fokus() {
            try {
                var cb = document.getElementById('chkObatBebas').checked;
                if (cb == false) {
                    var nama = ditrim(document.getElementById('txtNama').value);
                    var alamat = ditrim(document.getElementById('txtAlamat').value);
                    var tglahir = ditrim(document.getElementById('txtTglLahir').value);
                    if (nama == '') {
                        document.getElementById('txtNama').focus();
                        document.getElementById('txtNama').select();
                    }
                    else {
                        if (alamat = '') {
                            ...
                            if (tglahir == '') {
                                ...
                                document.getElementById('txtUmurTahun').select();
                            }
                            else {
                                var kdbarang;
