		...
		<TD width="100%" height="100%">
			...
			<asp:DataGrid id="gridResep" runat="server" Width="100%" AutoGenerateColumns="False" CellSpacing="0" BorderColor="Gainsboro" BorderWidth="1" GridLines="none" Height="100%" DataKeyField="counter" ShowFooter="True" CellPadding="0" AllowSorting="True">
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="nmdesc1" runat="server" HeaderText="Item" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
						<itemtemplate>
						    <table>
						        <tr>
					...
					<asp:TemplateColumn SortExpression="jamin" runat="server" HeaderText="Dijamin" HeaderStyle-HorizontalAlign="Center" Visible="false">
						<ItemTemplate>
					...
					<asp:TemplateColumn runat="server" HeaderText="Cito" HeaderStyle-HorizontalAlign="Center" Visible="False">
						<ItemTemplate>
						
							<asp:checkbox	runat=server 
											enabled=false 
											checked='<%# DataBinder.Eval(Container.DataItem, "cito") %>' 
											ID="_chkCito" />
