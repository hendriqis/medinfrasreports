							...
							<td width="50%" valign="top">
								...
								<TABLE width="100%" cellpadding=1 cellspacing=2>
									...
									<tr>
										...
										<td class=rBodyAddNewFld>
											<asp:label id="AddNewRow_QtyStock" runat="server" text="0.00" Visible="False" />
									...
									<tr>
										...
										<td width="60%" class=rBodyAddNewFld>
											...
											<asp:textbox id="AddNewRow_txtSelisih" runat="server" Readonly="False" width="175" Text="0.00" AutoPostBack="False" Visible="True" style="text-align:right;"/>											
										</td>
										<td class=rBodyAddNewFld>											
									...
									<tr>
										...
										<td width="40%" class=rBodyAddNewFld>
											<asp:textbox id="AddNewRow_txtDiskon" runat="server" width="354" Text="0.00" autopostback="False" style="text-align:right;" />
										</td>
										<td class=rBodyAddNewFld>											
