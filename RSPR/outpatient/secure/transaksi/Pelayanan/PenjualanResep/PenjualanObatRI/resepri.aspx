...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="resepri.aspx.vb" Inherits="QIS.Web.secure.transaksi.Pelayanan.PenjualanResep.PenjualanObatRI.resepri" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Penjualan Resep Pasien Rawat Inap</title>
...
<body ms_positioning="GridLayout" onload="ShowPosting();fokus();">
    ...
    <table border="0" style="height: 100%" width="100%" cellspacing="0" cellpadding="2">
        <tr>
                                        ...
                                        <td class="rheadercol" align="left" height="25" colspan="2">
                                            <a href="javascript:Done();">
                                                <img border="0" src="/qislib/images/back.png" alt="Kembali ke halaman Pilih Pasien"
                                                    align="absmiddle" />
                                            </a>&nbsp; Penjualan Resep Pasien Rawat Inap
                                        </td>
                                    </tr>
                                    <!-- Header Begin Here -->
                                    <tr class="rbody">
                                        <td class="rbodycol" align="middle" colspan="2">
                                            <!--#include file="resepri_hd.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <!-- Header End Here -->
                                    <tr class="rbody">
                                        <td class="rbodycol" align="middle" colspan="2">
                                            <!--#include file="resepri_addnewRow.incl.aspx" -->
                                            <!--#include file="resepri_Grid.incl.aspx" -->
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                    ...
                                    <tr>
                                        <td class="rBodyInfo" width="99%" valign="top">
                                            ...
                                            <div style="overflow: auto; width: 100%;" id="RelatedLinkDiv">
                                                <table width="100%" bgcolor="MintCream" cellspacing="10" cellpadding="0" border="0">
                                                    ...
                                                    <tr valign="top">
                                                        <td width="50%" id="CetakResepDokter1">
                                                            <p>
                                                        ...
                                                        <td align="left">
                                                            <input type="button" name="btnCtkResepDokter" id="btnCetakResepDokter" class="sbttn" style="display:none"
                                                                ...
                                                                value="Go..." onclick="javascript:window.open('http://' + location.host + '<%# QIS.Common.Hisconfiguration.CustomReportsFolder %>fm_/Bukti/Cetak_Resep_Dokter_RI.asp?is=' + document.getElementById('txtNoResep').value + '&nf=' + document.getElementById('txtNoBuktiResep').value + '&nojo=' + document.getElementById('txtNoJO').value + '',null,'status=no,resizable=yes,toolbar=no,menubar=no,location=no');" />                                                            
                                                        </td>
                                                        <td width="50%" id="rbup">
                                                            <p>
