        ...
        <td width="100%" height="100%">
            <asp:datagrid id="gridResep" runat="server" width="100%" autogeneratecolumns="False"
				...
				<Columns>
					...
					<asp:TemplateColumn SortExpression="Jenis" runat="server" HeaderText="+" HeaderStyle-HorizontalAlign="Center">
						<ItemTemplate>
					...
					<asp:TemplateColumn SortExpression="nmdesc1" runat="server" HeaderText="Nama Item" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
						<itemtemplate>
					...
					<asp:TemplateColumn SortExpression="nmsatobat" runat="server" HeaderText="Satuan" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
						<ItemTemplate>
					...
					<asp:TemplateColumn SortExpression="qtykemasO" runat="server" HeaderText="Qty Embalace Obat" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center" Visible="False">
						<ItemTemplate>
