...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KonfirmasiKenaikanHarga.aspx.vb"
    Inherits="QIS.Web.secure.utilities.KonfirmKenaikanHarga.KonfirmasiKenaikanHarga" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Konfirmasi Kenaikan Harga Penerimaan Barang</title>
                                ...
                                <table cellspacing="0" cellpadding="5" width="100%">
                                    <tr class="rheader">
                                        <td class="rheadercol" align="left" height="25">
                                            Konfirmasi Kenaikan Harga Penerimaan Barang
                                        </td>
                                    </tr>
                                    <tr class="rbody">
                                        <td>
                                                        ...
                                                        <div style="overflow: auto; width: 100%; height: 400">
                                                            <asp:DataGrid ID="gridMaintSP" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="Harga Pemesanan" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right" Visible="True">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" Text='<%# Format(DataBinder.Eval(Container.DataItem, "hargadsr"), "#,##0.00") %>'
                                                                                ID="_lblHargaNow" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn runat="server" HeaderText="Harga Penerimaan" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right" Visible="True">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="Selisih" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right" Visible="True">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" Text='<%# Format(DataBinder.Eval(Container.DataItem, "hargaterima") - DataBinder.Eval(Container.DataItem, "hargadsr"), "#,##0.00") %>'
                                                                                ID="_lblSelisih" style="color: #FF6600;" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
