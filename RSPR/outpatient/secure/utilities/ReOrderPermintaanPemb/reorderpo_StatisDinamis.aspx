...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reorderpo_StatisDinamis.aspx.vb"
    Inherits="QIS.Web.secure.utilities.ReOrderPermintaanPemb.reorderpo_StatisDinamis" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 TRANSITIONAL//EN">
<html>
<head>
    <title>Re-Order Permintaan Pembelian</title>
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10%">
                                                            Filter:
                                                            <br />
                                                            <asp:TextBox ID="txtfilter" runat="server" Width="100%" Text=""></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <br />
                                                            <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="sbttn" Visible="False">
                                                            </asp:Button>
                                                            <asp:Button ID="btnHitungReorder" runat="server" Text="Hitung Re-Order" CssClass="sbttn">
                                                            </asp:Button>
                                                            <asp:Button ID="btnGeneratedPO" runat="server" Text="Proses PR" Width="100" CssClass="sbttn">
                                                            </asp:Button>
