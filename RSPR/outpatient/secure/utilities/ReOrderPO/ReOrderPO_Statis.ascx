<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ReOrderPO_Statis.ascx.vb"
    Inherits="QIS.Web.ReOrderPO_Statis" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
