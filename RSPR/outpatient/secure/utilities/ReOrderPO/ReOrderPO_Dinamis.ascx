<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ReOrderPO_Dinamis.ascx.vb"
    Inherits="QIS.Web.ReOrderPO_Dinamis" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
            ...
            <asp:Panel ID="SectionPanel" runat="server">
                <asp:DataGrid ID="gridReorderPO" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn runat="server" HeaderText="Min" ItemStyle-HorizontalAlign="Center"
                        ...
                        <asp:TemplateColumn runat="server" HeaderText="Max" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="leadtime" runat="server" HeaderText="LT" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="safetytime" runat="server" HeaderText="ST" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="safetystock" runat="server" HeaderText="X" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="average" runat="server" HeaderText="Pemakaian Rata-rata" ItemStyle-HorizontalAlign="Center"
                        ...
                        <asp:TemplateColumn runat="server" HeaderText="Saldo All" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="opo" runat="server" HeaderText="On Order" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="True">
                            <ItemTemplate>
                                <asp:Label runat="server" Style="margin-left: 5; margin-right: 5" Text='<%# format(DataBinder.Eval(Container.DataItem, "opo"), "#,##0.00") %>'
                        ...
                        <asp:TemplateColumn SortExpression="opp" runat="server" HeaderText="On Request" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="True">
                            <ItemTemplate>
                                <asp:Label runat="server" Style="margin-left: 5; margin-right: 5" Text='<%# format(DataBinder.Eval(Container.DataItem, "opp"), "#,##0.00") %>'
                        ...
                        <asp:TemplateColumn SortExpression="satuankc" runat="server" HeaderText="Satuan" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn SortExpression="qtypesan" runat="server" HeaderText="Pesan" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-HorizontalAlign="Center" Visible="True">
                            <ItemTemplate>
                                <asp:TextBox ID="txtQtyPesan" AutoPostBack="False" runat="server" Style="margin-left: 5;
                                    margin-right: 5" BackColor="Transparent" Text='<%# format(DataBinder.Eval(Container.DataItem, "qtypesan"), "#,##0.00") %>'
