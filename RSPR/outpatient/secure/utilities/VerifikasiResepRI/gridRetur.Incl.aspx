<asp:DataGrid	id="gridRetur" 
	...
	<Columns>
		...
		<asp:TemplateColumn runat="server"
			...
			<ItemTemplate>
				...
				<asp:checkbox	runat=server 
								enabled='<%# DataBinder.Eval(Container.DataItem, "posting") %>' 
								checked=false
								ID="_chkPesan" />
		...
		<asp:TemplateColumn SortExpression="nobukti" 
							runat="server" 
							HeaderText="No. Retur" 
		...
		<asp:TemplateColumn SortExpression="tgtrans" 
							runat="server" 
							HeaderText="Tgl. Retur" 
							ItemStyle-HorizontalAlign="Center" 
							HeaderStyle-HorizontalAlign="Center" 
							Visible="True">
			<itemtemplate>
				...
				<asp:label	runat="server"	
							style="margin-left:5;margin-right:5" 
							Text='<%# Format(DataBinder.Eval(Container.DataItem, "tgtrans"), "dd-MM-yyyy") %>' 
							ID="_lblTanggal"/>
