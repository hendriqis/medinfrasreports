<%@ Page Language="vb" AutoEventWireup="false" Codebehind="InfoResep.aspx.vb" Inherits="QIS.Web.utilities.Rekalkulasi.InfoResep"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<HTML>
	<HEAD>
		<title>QIS .Net Hospital Information System - Informasi Resep Rawat Inap</title>
					...
					<tr>
						<td style="PADDING-TOP: 5px" align="left">
								...
								<TABLE cellSpacing="0" cellPadding="5" width="100%">
									...
									<TR class="rheader">
										<TD class="rheadercol" align="left" height="25">INFORMASI RESEP RAWAT INAP (<asp:label	id="lblNama" runat="server" />)
										</TD>
									</TR>
