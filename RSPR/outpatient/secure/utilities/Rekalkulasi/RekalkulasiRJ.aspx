...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RekalkulasiRJ.aspx.vb"
    Inherits="QIS.Web.secure.utilities.Rekalkulasi.RekalkulasiRJ" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 TRANSITIONAL//EN">
<html>
<head>
    <title>Rekalkulasi Penjualan Resep Pasien Rawat Jalan</title>
                                                        ...
                                                        <td>
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtTanggalReg" runat="server" ReadOnly="true" Width="95%" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtKodePoliklinik" runat="server" MaxLength="10" Width="24%" />
                                                                        <asp:TextBox ID="txtNamaPoliklinik" runat="server" ReadOnly="true" Width="70%" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
