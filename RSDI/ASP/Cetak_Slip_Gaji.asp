...
<%
	...
	strsql2 = "sppgrpt_Cetak_Slip_Gaji_Pendapatan '" & parm & "'"
	
	' SQL Statement for Sub Report 2..!!
	strsql3 = "sppgrpt_Cetak_Slip_Gaji_Pengurang '" & parm & "'"
	...
	Set CRXSubreport = session("oRpt").OpenSubreport("Slip_Gaji_Pedapatan")
